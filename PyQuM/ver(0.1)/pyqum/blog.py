...
def index():
    ...
    esgstat = get_status('ESG')
    awgstat = get_status('AWG')
    return render_template('blog/index.html', posts=posts, esgstat=esgstat, awgstat=awgstat)
