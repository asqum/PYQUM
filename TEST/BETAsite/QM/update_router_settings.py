...
# To use, connect the computer directly into any one of the router's ports (excluding port 1), and run the script.
# If the router current state is unknown, please reset it back to default settings before running this script.
...
args = shlex.split(f'ssh -o "UserKnownHostsFile=/dev/null" -o "StrictHostKeyChecking=no" admin@192.168.88.1')
logs = ""
