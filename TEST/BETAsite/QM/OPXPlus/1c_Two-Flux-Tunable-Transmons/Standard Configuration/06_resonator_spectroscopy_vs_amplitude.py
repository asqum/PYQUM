...
with program() as multi_res_spec_vs_amp:
    ...
    with stream_processing():
        ...
        # resonator 3
        I_st[1].buffer(len(amplitudes)).buffer(len(dfs)).average().save("I3")
        Q_st[1].buffer(len(amplitudes)).buffer(len(dfs)).average().save("Q3")
...
if simulate:
    ...
    while results.is_processing():
        ...
        # Plot
        plt.suptitle("Power dep. Resonator spectroscopy")
