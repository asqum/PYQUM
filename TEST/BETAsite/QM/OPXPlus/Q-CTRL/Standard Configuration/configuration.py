...
# Qubits IF
qubit_IF_q1 = (-329.081 -0.245-0.162) * u.MHz #(4013-0.0088-0.0037 -4200) * u.MHz
qubit_IF_q2 = (473.166 ) * u.MHz #(4156-0.119  -4200) * u.MHz
...
readout_len = 2480
readout_amp_q1 = 0.125*0.59
readout_amp_q2 = 0.125*1.09
