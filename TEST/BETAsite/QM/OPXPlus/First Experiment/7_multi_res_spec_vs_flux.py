...
dfs = np.arange(-1.5e6, + 1.5e6, 0.02e6)
n_avg = 10000
    ...
    with for_(n, 0, n < n_avg, n+1):
        ...
        with for_(*from_array(df, dfs)):
            ...
            with for_(i, 0, i<flux_pts, i+1):
                ...
                # resonator 1
                measure("readout"*amp(0.1), "rr1", None, dual_demod.full("cos", "out1", "sin", "out2", I[0]),
                ...
                measure("readout"*amp(0.1), "rr2", None, dual_demod.full("cos", "out1", "sin", "out2", I[1]),
