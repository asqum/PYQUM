...
#               Flux line                #
##########################################
flux_settle_time = 900 * u.ns

max_frequency_point1 = 0.075-0.0239-0.0022
max_frequency_point2 = 0.043-0.0251-0.0030

idle_q1 = max_frequency_point1 # +0.1 -0.035
idle_q2 = max_frequency_point2 # +0.0 -0.035
...
# Resonators IF
resonator_IF_q1 = int((-156.22) * u.MHz)
# resonator_IF_q2 = int((36.2) * u.MHz)
resonator_IF_q2 = int((136.81) * u.MHz) 
