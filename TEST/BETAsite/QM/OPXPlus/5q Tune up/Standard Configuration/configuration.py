...
#                  Qubits                   #
#############################################
qubit_LO_q1 = 4.200 * u.GHz
qubit_LO_q2 = 4.200 * u.GHz
...
# Qubits IF
qubit_IF = np.zeros(5)
qubit_IF[0] = (-186.24) * u.MHz #(4013-0.0088-0.0037 -4200) * u.MHz
qubit_IF[1] = (-44.4216-0.032) * u.MHz #(4156-0.119  -4200) * u.MHz
qubit_IF[2] = (-44.4216-0.032) * u.MHz
...
max_frequency_point1 = 0#0.075-0.0239-0.0022
max_frequency_point2 = 0#0.043-0.0251-0.0030
max_frequency_point3 = 0
max_frequency_point4 = 0
max_frequency_point5 = 0

idle_q1 = max_frequency_point1 + 0.0
idle_q2 = max_frequency_point2 + 0.0
idle_q3 = max_frequency_point3 + 0.0
...
resonator_IF[0] = int((-158) * u.MHz)
resonator_IF[1] = int((135.8) * u.MHz)
resonator_IF[2] = int((-39.3) * u.MHz)
resonator_IF[3] = int((228.1) * u.MHz)
resonator_IF[4] = int((35.9) * u.MHz)
...
readout_amp[0] = 0.02 #0.125*0.59
readout_amp[1] = 0.02 #0.125*1.09
readout_amp[2] = 0.182
readout_amp[3] = 0.201
readout_amp[4] = 0.097
...
rotation_angle_q1 = (291.7 / 180) * np.pi
rotation_angle_q2 = (47.5 / 180) * np.pi
rotation_angle_q3 = (0 / 180) * np.pi
rotation_angle_q4 = (0 / 180) * np.pi
rotation_angle_q5 = (0 / 180) * np.pi
ge_threshold_q1 = 7.691e-04
ge_threshold_q2 = 6.522e-04
ge_threshold_q3 = 0
ge_threshold_q4 = 0
ge_threshold_q5 = 0
