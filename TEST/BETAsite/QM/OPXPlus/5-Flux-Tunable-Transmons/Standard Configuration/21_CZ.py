...
# amps = (np.arange(0.27, 0.29, 0.00002) - flux_offset) / scale_reference # q2->q3
...
if simulate:
    ...
    while results.is_processing():
        ...
        plt.axhline(cz_duration, color="k", linewidth=0.37)
        plt.axvline(cz_point, color="k", linewidth=0.37)
        plt.subplot(223)
        plt.cla()
