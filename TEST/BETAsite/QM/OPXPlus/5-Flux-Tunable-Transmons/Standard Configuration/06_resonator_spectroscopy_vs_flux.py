        ...
        with for_(*from_array(df, dfs)):
            ...
            with for_(*from_array(dc, flux)):
                ...
                if center == "max":
                    ...
                    set_dc_offset("q2_z", "single", max_frequency_point2 + dc)
                    set_dc_offset("q3_z", "single", max_frequency_point3 + dc)
                    set_dc_offset("q4_z", "single", max_frequency_point4 + dc)
                    set_dc_offset("q5_z", "single", max_frequency_point5 + dc)
...
if simulate:
    ...
    while results.is_processing():
        ...
        phase5 = np.angle(S5)
        # Plots
        plt.suptitle("Flux dep. Resonator spectroscopy (%s/%s)" %(n,n_avg))
        # rr1:
        ...
        plt.axvline(0, color="k", linewidth=0.37)
        # rr2:
