...
- Perform an energy relaxation timescan to find the T1 of a qubit
...
class EnergyRelaxation(Experiment):
    """
...
T1_test = EnergyRelaxation(system)
results_T1 = backend.execute(T1_test)

if use_hardware:
    plot_results_single_sweep(results_T1)

# %%

"""
Next, the customer would analyze the results to calculate the T1 coherence time of their qubits
"""