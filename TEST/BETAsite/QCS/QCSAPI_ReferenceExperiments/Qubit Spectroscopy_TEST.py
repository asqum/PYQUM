...
class QubitSpectroscopyExperiment(Experiment):
    ...
    sweep = Sweep(
        ...
        spec_frequency=np.linspace(4.05e9, 4.45e9, 3),
    )
    ...
    def make_sequence(self, sequence_builder: SequenceBuilder):
        ...
        # There are two qubits defined in the YAML file.
        # Set the frequency for each to the same frequency output.
        for qubit in qubits:
        ...
        # We have a readout on Channel 1 and Channel 4. Perform a
        # parallel measurement on each.
        sequence_builder.append_in_parallel(
...
if use_hardware:
    ...
    readout_frequencies = [3.9e9, 3.9e9]
else:
