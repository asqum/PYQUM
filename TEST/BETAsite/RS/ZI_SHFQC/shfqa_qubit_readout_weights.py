...
device.scopes[SCOPE_CHANNEL].configure(
    ...
    trigger_delay=220e-9,
)

# In[4] Generate waveforms
...
for i in range(NUM_QUBITS):
    ...
    # )
    device.system.internaltrigger.repetitions(NUM_MEASUREMENTS)
    device.system.internaltrigger.holdoff(READOUT_DURATION)
