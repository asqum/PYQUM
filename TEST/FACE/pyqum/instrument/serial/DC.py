...
def test():
    ...
    X0 = waveform("0 to -10 *150 to 10 *300 to 0 *150") # waveform("0 to 5 *700 to 10*1300 to 0 * 1000"), waveform("0 to 3 *700  to 1*1500 to 7*500 to 0 * 300")
    M = measure(sample_rate=300, duty_cycle=0.8, samps_per_chan=X0.count)
