...
try:
    lib_name = find_library('KtM9347_64.dll')
    lib_name = "C:\\Program Files\\Keysight\\M9347\\bin\\KtM9347Fundamental.dll"
...
def test(detail=True):
    # import sys
    # sys.path.append('C:\\Users\\ASQUM\\Documents\\MEGAsync\\MANUALS\\AWGDIG\\KeySight\\QES(2.0)\\Keysight_QES_DriverPackage\\QExampleS\\DDSLO\\Python')
    # import ktm9347 as LO
    # s = LO.KtM9347()
    # module = 1
    # s.connect("TCPIP0::localhost::hislip%s::INSTR" %module)
    # print("Status: %s" %s.is_connected())
    # print("session: %s" %s.__session)
    # print(s.get_clock_frequency())
