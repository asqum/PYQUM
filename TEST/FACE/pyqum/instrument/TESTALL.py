...
from pyqum.instrument.benchtop import MXG, DSO, ESG, PNA, ENA, PSGV, PSGA, RDSO, YOKO, GW32, KEIT, DSA8, RSA5
...
MDL = ['AWG', 'VSA', 'ENA', 'PSGV', 'PSGA', 'RDS', 'MXG', 'DSO', 'YOKO', 'LAKE', 'DC', 'GW32', 'KEIT', 'DSA8', 'RSA5', #instruments
