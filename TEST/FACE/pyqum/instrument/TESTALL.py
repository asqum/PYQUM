...
from pyqum.instrument.benchtop import MXG, DSO, ESG, PNA, ENA, PSGV, PSGA, RDS, YOKO, GW32, KEIT, DSA8
...
MDL = ['AWG', 'VSA', 'ENA', 'PSGV', 'PSGA', 'RDS', 'MXG', 'DSO', 'YOKO', 'LAKE', 'DC', 'GW32', 'KEIT', 'DSA8', #instruments
