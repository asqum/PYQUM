import visa
from numpy import arange, sqrt, arctan, frombuffer, array, linspace, pi
...
# start measurement
# ena.write(":ABOR;:TRIG:SOUR INT;:INIT:CONT ON")
...
# ena.write(":STAT:OPER:NTR 16")
# ena.write(":STAT:OPER:ENAB 16")
# ena.write("*SRE 128;*CLS")
ena.query("*OPC?")
...
X = list(linspace(fstart, fstop, datapts//2))
