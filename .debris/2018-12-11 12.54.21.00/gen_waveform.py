...
def squarewave(seg0, seg1):
    ...
    i = 1
    if i:
        stat = AWG.CreateArbWaveform(s, ([i*0 + 0.5 for i in range(seg0)] + [i*0 for i in range(seg1)] + [i*1 for i in range(seg0)]))
        Seq = {}
    ...
    i = 1
    if i:
        stat = AWG.CreateArbWaveform(s, list([i*0 for i in range(seg1)] + [i*1 for i in range(seg0)] + [i*0 for i in range(seg1)]))
        Seq2 = {}
