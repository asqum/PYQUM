...
Peakidx_UPHA_fft = [i for i in indexes(UPHA_fft, thres=0.02/max(UPHA_fft), min_dist=0.1)]
Peakidx_UPHA_fft = tuple(slice(i) for i in Peakidx_UPHA_fft)
...
ax.plot(X[Peakidx_UPHA_fft], UPHA_fft[Peakidx_UPHA_fft])
ax.set(ylabel=r' unwrapped Phase (rad)', xlabel=r'$frequency (Hz)$',
