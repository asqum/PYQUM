...
f, spec, UPHA_fft = FFT_deNoise(UPHA_flat[avebox:-avebox]*1e8, X[1]-X[0], 0.001)

indices = indexes(UPHA_fft, thres=0.2/max(UPHA_fft), min_dist=0.1)
...
ax.plot(X_peak, Y_peak, marker='+', color='r')
ax.set(ylabel=r' unwrapped Phase (rad)', xlabel=r'$frequency (Hz)$',
