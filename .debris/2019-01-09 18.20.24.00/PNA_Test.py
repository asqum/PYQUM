...
# attribute of 'frequency' in PNA [done]
...
# port extension calibration
pna.write("SENS:CORR:EXT:AUTO:RESet")
pna.write("SENS:CORR:EXT ON")

pna.write("SENS:CORR:EXT:AUTO:PORT OFF")
...
status = pna.write("SENSe:AVER ON") #OFF
