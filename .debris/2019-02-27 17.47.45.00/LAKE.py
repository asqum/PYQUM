...
try:
    address = "visa://192.168.1.23:7777/ASRL0::INSTR"
    ...
    bench.write("display 2,4,0")
    # bench.write("display 1,2,1")

except visa.VisaIOError as e:
    print(set(e.args[0].split('(')[1]) & set(e.args[0].split(')')[0]))
    print(rm.last_status)
    print(rm.visalib.last_status)
    print(visa.constants.StatusCode(-1073807279))