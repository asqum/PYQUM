...
def squarewave(seg0, seg1):
    ...
    i = 1
    if i:
        stat = AWG.CreateArbWaveform(s, list([0]*seg0 + [1]*seg1 + [0]*seg0))
        Seq = [stat[1]]
        counts = [1] #loopcount
    ...
    i = 1
    if i:
        stat = AWG.CreateArbWaveform(s, list([0]*seg1 + [1]*seg1))
        h1 = stat[1]
        stat = AWG.CreateArbWaveform(s, ([1]*seg1))
        h2 = stat[1]
        Seq2 = [h1, h2]
        counts = [1, 1] #loopcount
        stat = AWG.CreateArbSequence(s, Seq2, counts)
